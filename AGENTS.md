...
check [.Codex/CODEBASE.md](.Codex/CODEBASE.md) and all the related linked documents first. Only go through files when
...
|-----------------|--------------------------------------------------------------------------|-----------------------------------------|
| Rust            | Writing, reviewing, or debugging Rust code                               | `.Codex/knowledge/rust.md`             |
| Typescript      | Typescript code, FyndClient, changes to public interfaces, openapi       | `.Codex/knowledge/typescript.md`       |
| Version control | git, branch, commit, PR, push, rebase, merge, cherry-pick, tag, release  | `.Codex/knowledge/version_control.md`  |
...
- `sync-docs`: Review all codebase documentation and update Codex docs
